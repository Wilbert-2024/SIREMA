...
///Total Centro Padre
$totalCentroPadre = 0;
$totalCentroFemPadre = 0;
$totalCentroMasPadre = 0;

$idCentroPadreActual = 0;
$descripcionCentroPadre = '';
////Total General
$totolGeneral = 0;
$totalGeneralFem = 0;
$totalGeneralMas = 0;
...
{
    if($idCentroPadreActual == 0)
    {
        $idCentroPadreActual = $reg['Padre_Id'];
        $descripcionCentroPadre = $reg['Padre'];
    }
    if($idCentroPadreActual != $reg['Padre_Id'])
    {

        $pdf->Ln(8);
        $pdf->SetFont('helvetica', 'B', 13);
        $pdf->Cell(115, 4, 'ATIENDE ** '.$descripcionCentroPadre.' ** ', 0, 0, 'L');
        $pdf->Cell(20, 4,$totalCentroFemPadre, 1, 0, 'L');
        $pdf->Cell(20, 4,$totalCentroMasPadre, 1, 0, 'L');
        $pdf->Cell(20, 4,$totalCentroPadre, 1, 0, 'L');
    ...
    $pdf->Cell(40, 5, 'Programa', 0, 0, 'C', 0);
    $pdf->Cell(60, 5, 'Municipio', 0, 0, 'C', 0);
    $pdf->Cell(60, 5, 'Comunidad', 0, 0, 'C', 0);
    $pdf->Ln(5);
    $pdf->SetFont('helvetica', 'N', 11);
    $pdf->Cell(20, 5, '', 0, 0, 'C', 0);
    $pdf->Cell(40, 5, "UNICAM", 0, 0, 'C', 0);
    $pdf->Cell(60, 5, $reg['Mun'], 0, 0, 'C', 0);
    $pdf->Cell(60, 5, $reg['Com'], 0, 0, 'C', 0);
    $pdf->Ln(7);
   // $pdf->Cell(30, 5, 'Atiende', 0, 0, 'C', 0);
    $pdf->SetFont('helvetica', 'B', 13);
    $pdf->Cell(20, 5, '', 0, 0, 'C', 0);
    $pdf->Cell(40, 5, 'Tipo Ingreso', 0, 0, 'C', 0);
    ...
    $pdf->Ln(5);
    $pdf->Cell(20, 5, '', 0, 0, 'C', 0);
   // $pdf->Cell(30, 5, $reg['Padre'], 0, 0, 'C', 0);
    $pdf->Cell(40, 5, $reg['TI'], 0, 0, 'C', 0);
    ...
    $totalCentroPadre = $totalCentroPadre + $totalCentro;
    $totalCentroFemPadre = $totalCentroFemPadre + $totalCentroFem;
    $totalCentroMasPadre = $totalCentroMasPadre + $totalCentroMas;
...
$pdf->Ln(8);
$pdf->SetFont('helvetica', 'B', 13);
$pdf->Cell(155, 4, 'ATIENDE ** '.$descripcionCentroPadre.' ** ', 0, 0, 'L');
$pdf->Cell(15, 4,$totalCentroFemPadre, 1, 0, 'L');
$pdf->Cell(15, 4,$totalCentroMasPadre, 1, 0, 'L');
$pdf->Cell(15, 4,$totalCentroPadre, 1, 0, 'L');

$pdf->Ln(13);
$pdf->SetFont('helvetica', 'B', 13);
$pdf->Cell(155, 4, 'TOTAL GENERAL UNICAMS ** ', 0, 0, 'L');
